      ...
      <main className="bg-black min-h-screen">
        <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-6xl font-black text-white uppercase leading-none mb-4">Chattanooga <span className="text-brand">Grappling Club</span></h1>
            <div className="w-24 h-1 bg-brand mx-auto mb-6" />
            <p className="text-gray-300 text-lg">Chattanooga, TN</p>
          </div>
        </section>
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-black text-white uppercase mb-6">CHATTANOOGA <span className="text-brand">GRAPPLING CLUB</span></h2>
              <div className="w-16 h-1 bg-brand mb-8" />
              <p className="text-gray-300 leading-relaxed mb-4">Chattanooga Grappling Club is a Team Curran certified affiliate located in Chattanooga, Tennessee. They bring the Team Curran standard of Jiu-Jitsu instruction to the Chattanooga community.</p>
              <p className="text-gray-300 leading-relaxed mb-8">As part of the Team Curran network and the Pedro Sauer BJJ Association, Chattanooga Grappling Club provides students with access to a world-class curriculum in a supportive training environment.</p>
              <div className="flex flex-wrap gap-3 mb-8">
                {["Brazilian Jiu-Jitsu", "Grappling", "Self-Defense", "All Levels"].map(p => (
            ...
            <div className="space-y-5">
              {[
                { label: "LOCATION", value: "Chattanooga, TN", icon: "📍" },
