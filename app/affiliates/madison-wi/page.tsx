...
export default function MadisonWIPage() {
  return (
    <>
      <Navbar />
      <main className="bg-black min-h-screen">
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
          <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/team-curran-madison.jpg')" }} />
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-6xl font-black text-white uppercase leading-none mb-4">
              Team Curran <span className="text-brand">Madison, WI</span>
            </h1>
            <div className="w-24 h-1 bg-brand mx-auto mb-6" />
            <p className="text-gray-300 text-lg">Madison, WI</p>
          </div>
        </section>
        ...
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-black text-white uppercase mb-6">TEAM CURRAN <span className="text-brand">MADISON</span></h2>
              <div className="w-16 h-1 bg-brand mb-8" />
              <p className="text-gray-300 leading-relaxed mb-4">
                Team Curran Madison is the official Team Curran affiliate academy in Madison, Wisconsin. As a direct extension of Team Curran Headquarters, this location upholds the same high standards of Jiu-Jitsu instruction and character development.
              </p>
              <p className="text-gray-300 leading-relaxed mb-8">
                Proudly part of the Pedro Sauer BJJ Association, Team Curran Madison provides students with access to one of the most respected Jiu-Jitsu lineages in the world.
              </p>
              <div className="flex flex-wrap gap-3 mb-8">
                {["Brazilian Jiu-Jitsu", "Gracie Jiu-Jitsu", "Pedro Sauer Association", "All Levels"].map(p => (
              ...
              <a href="https://www.wi-mafc.com" target="_blank" rel="noopener noreferrer"
            ...
            <div className="space-y-5">
              {[
                { label: "LOCATION", value: "Madison, WI", icon: "📍" },
                { label: "WEBSITE", value: "wi-mafc.com", icon: "🌐" },
              ...
              <a href="https://maps.google.com/?q=Team+Curran+Jiu-Jitsu+Madison+WI" target="_blank" rel="noopener noreferrer"
