      ...
      <main className="bg-black min-h-screen">
        <section className="relative min-h-[55vh] flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <p className="text-gray-300 text-lg">Pennsylvania</p>
          </div>
        </section>
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed mb-4">PA Grappling is a Team Curran certified affiliate bringing high-level Brazilian Jiu-Jitsu to Pennsylvania. As part of the Team Curran network, they deliver the same proven curriculum and standards upheld at Team Curran Headquarters.</p>
              <p className="text-gray-300 leading-relaxed mb-8">Whether you are a complete beginner or an experienced competitor, PA Grappling provides a professional and welcoming training environment for students of all levels.</p>
            ...
            <div className="space-y-5">
              {[
                { label: "LOCATION", value: "Pennsylvania", icon: "📍" },
              ...
              <Link href="/#contact" className="block text-center bg-brand hover:bg-blue-800 text-white font-black uppercase tracking-widest px-8 py-3 rounded transition-colors">CONTACT US FOR MORE INFO</Link>
            </div>
          </div>
        </section>
