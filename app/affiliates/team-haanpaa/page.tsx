...
export default function TeamHaanpaaPage() {
  return (
    <>
      <Navbar />
        ...
        <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
          ...
          <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
            ...
            <h1 className="text-4xl sm:text-6xl font-black text-white uppercase leading-none mb-4">
              Team Haanpaa <span className="text-brand">Martial Arts</span>
            </h1>
            <div className="w-24 h-1 bg-brand mx-auto mb-6" />
            <p className="text-gray-300 text-lg">Rockford, IL & Beloit, WI</p>
          </div>
        </section>
        ...
        <section className="py-20 px-4">
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <h2 className="text-3xl font-black text-white uppercase mb-6">TEAM HAANPAA <span className="text-brand">MARTIAL ARTS</span></h2>
              <div className="w-16 h-1 bg-brand mb-8" />
              <p className="text-gray-300 leading-relaxed mb-4">
                Team Haanpaa Martial Arts is a proud Team Curran certified affiliate serving the Rockford, IL and Beloit, WI areas. They offer world-class Brazilian Jiu-Jitsu, Muay Thai Kickboxing, and Kids Martial Arts programs for all ages and skill levels.
              </p>
              <p className="text-gray-300 leading-relaxed mb-8">
                The academy emphasizes community building, professional instruction, and personal growth — serving students throughout Rockford, Byron, Cherry Valley, Belvidere, and the state-line area.
              </p>
              <div className="flex flex-wrap gap-3 mb-8">
                {["Brazilian Jiu-Jitsu", "Muay Thai", "Kids Martial Arts", "Self-Defense", "Women's Classes"].map(p => (
              ...
              <a href="https://www.teamhaanpaa.com" target="_blank" rel="noopener noreferrer"
            ...
            <div className="space-y-5">
              {[
                { label: "LOCATIONS", value: "Rockford, IL (4911 26th Ave)\nHMA Beloit, WI", icon: "📍" },
                { label: "PHONE", value: "(815) 451-3001", icon: "📞" },
                { label: "HOURS", value: "Mon/Wed: 8am–9pm\nTue/Thu/Fri: 8am–6pm", icon: "🕐" },
              ...
              <a href="https://maps.google.com/?q=4911+26th+Avenue+Rockford+IL+61109" target="_blank" rel="noopener noreferrer"
