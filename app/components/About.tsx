      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            <div className="aspect-[4/5] rounded-lg overflow-hidden bg-gray-800 border border-red-900/40">
              <img
                src="https://placehold.co/600x750/1f1f1f/444444?text=Professor+Jeff+Curran"
                alt="Professor Jeff Curran"
                className="w-full h-full object-cover"
              />
            </div>
            {/* Accent badge */}
            <div className="absolute -bottom-6 -right-6 bg-red-600 text-white px-6 py-4 rounded text-center shadow-xl">
          ...
          <div>
            ...
            <h2 className="text-4xl sm:text-5xl font-black text-white uppercase leading-tight mb-6">
              Jeff <span className="text-red-600">Curran</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <span
                  key={badge}
                  className="bg-gray-800 border border-red-900/50 text-gray-300 text-xs font-semibold px-3 py-1.5 rounded uppercase tracking-wide"
                >
                  {badge}
                </span>
              ))}
