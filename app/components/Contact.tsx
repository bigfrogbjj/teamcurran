            ...
            >
              <div className="grid sm:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-800 border border-gray-700 focus:border-red-600 text-white placeholder-gray-600 rounded px-4 py-3 text-sm outline-none transition-colors"
                  />
                </div>
                <div>
                  <label className="block text-gray-400 text-xs font-bold uppercase tracking-widest mb-1.5">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-gray-800 border border-gray-700 focus:border-red-600 text-white placeholder-gray-600 rounded px-4 py-3 text-sm outline-none transition-colors resize-none"
                />
              </div>
              <button
                type="submit"
                className="w-full bg-red-600 hover:bg-red-700 text-white font-black uppercase tracking-widest py-4 rounded text-sm transition-colors shadow-lg shadow-red-900/40"
              >
                Send Message
              </button>
            </form>
